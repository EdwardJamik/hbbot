...
function Sidenav() {
  ...
  async function getUserRoot() {
    const {data} = await axios.post(`${url}/api/v1/admin/rootMenu`, {cookies});

    setUserEntree(data?.root ? data.root : [])

    return setUserRoot(data?.root_manager ? data?.root_manager : false)
  }
  ...
  return (
      <>
        ...
        <Menu theme="light" mode="inline">
          ...
          {userEntree[7] && (
              <Menu.Item key="7">
                <NavLink to="/bot_channels">
            <span
                className="icon"
                style={{
                  background: page === "bot_channels" ? '#a3842ed9' : "",
                }}
            >
              {bot_channel}
            </span>
          ...
          {userRoot && (
            ...
            >
              {profile}
                  ...
                  <span className="label">Менеджеры</span>
                </NavLink>
              </Menu.Item>
          )}
          <Menu.Item key="9">
