            ...
            >
                <form className="modal_sendings">
                    ...
                    <div>
                        <p>Контент:</p>
                        <p>En:<span
                            style={{fontWeight: '400'}}> {formData.content.en && `${formData.content.en}`}</span></p>
                        <p>Ru:<span
                            style={{fontWeight: '400'}}> {formData.content.ru && `${formData.content.ru}`}</span></p>
                        <p>Uk:<span
                            style={{fontWeight: '400'}}> {formData.content.uk && `${formData.content.uk}`}</span></p>
                        <p>Es:<span
                            style={{fontWeight: '400'}}> {formData.content.es && `${formData.content.es}`}</span></p>
                    </div>
